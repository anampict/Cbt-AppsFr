...
const validationSchema = z.object({
  ...
  provinsiKode: z.string().min(1, { message: "Provinsi harus diisi" }),
  provinsi: z.string().min(1, { message: "Provinsi harus diisi" }),
  kotaKode: z.string().min(1, { message: "Kota harus diisi" }),
  kota: z.string().min(1, { message: "Kota harus diisi" }),
  kecamatanKode: z.string().min(1, { message: "Kecamatan harus diisi" }),
