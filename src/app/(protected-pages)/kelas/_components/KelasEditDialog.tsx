...
import type { Kelas, KelasFormData } from "../types";
...
const KelasEditDialog = ({
  isOpen,
  onClose,
  kelas,
  onSuccess,
}: KelasEditDialogProps) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await KelasService.updateKelas(kelas.id, data);

      toast.push(
        <Notification type="success">Kelas berhasil diupdate!</Notification>,
        {
          placement: "top-center",
        }
      );
  ...
  return (
    ...
    >
      <div className="flex flex-col h-full justify-between">
        <h5 className="mb-4">Edit Kelas</h5>
...
export default KelasEditDialog;
